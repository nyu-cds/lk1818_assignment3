...
############ Using alternatives to membership testing of lists. (Area 2)
############ This area of improvement ranked the 3rd.
############ runtime: 85.68s 
############ relative speedup: 1.35x
...
def advance(dt):
    ...
    '''
    # For membership operations, always use a set instead of a list
    seenit = set()
    for body1 in BODIES.keys():
        for body2 in BODIES.keys():
            if (body1 != body2) and not (body2 in seenit):
                ...
                # Change corresponding to the list - set replacemnet
                seenit.add(body1)
