...
############ Using local rather than global variables. (Area 3)
############ This area of improvement ranked the last.
############ runtime: 86.25s 
############ relative speedup: 1.33x

# Move the declaration of all global variables in the main function.
