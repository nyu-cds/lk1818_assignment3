...
This is the numba-compatible code of nbody_opt.py

Author: lk1818


Conversions:
Added @jit decorations
Added signatures
Added vec_deltas ufunc
"""
...
@jit("void(float64, int32, optional(dict))")
...
@jit("float64(optional(dict), float64)")
